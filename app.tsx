    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      >
        ...
        <div className="p-4 border-b border-gray-200 flex items-center justify-between flex-shrink-0">
          {sidebarOpen && <h1 className="text-xl font-bold text-gray-800">原型平台</h1>}
          <button
      ...
      <div className="flex-1 min-h-0 overflow-hidden flex flex-col">
        <Routes>
          ...
          <Route
            ...
            element={
              <PageScroll>
                <HomePage pages={pages} onNavigate={handleNavigation} />
              </PageScroll>
            }
          />
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600">欢迎使用原型开发平台，这里汇集了所有的原型页面</p>
      </div>

      {pages.length === 0 ? (
        <div className="text-center py-12">
          <FileText size={64} className="mx-auto text-gray-400 mb-4" />
          <h3 className="text-xl font-semibold text-gray-700 mb-2">暂无原型页面</h3>
          <p className="text-gray-500">在 pages 目录下创建 .tsx 文件来添加新的原型页面</p>
        </div>
      ) : (
          ...
          {pages.map((page) => (
            ...
            >
              ...
              <div className="px-6 py-3 bg-gray-50 border-t border-gray-200">
                <span className="text-xs text-gray-500">路径: /{page.path}</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="mt-12 text-center">
        <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
          ...
          <p className="text-blue-700 text-sm">
            在 <code className="bg-blue-100 px-2 py-1 rounded">pages/</code> 目录下创建新的 .tsx
            文件，系统会自动识别并添加到导航中
          </p>
        </div>
      </div>
